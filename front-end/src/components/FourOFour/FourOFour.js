  ...
  return (
    <div className="fourOFour">
      ...
      <div className="fourOFour__words">
        <div className="fourOFour__words__cIsFor">
          C is for...
        </div>
        <div>
        <div className="fourOFour__words__wordsWithC" onClick={handleRandomClick}>
          <div>
            <img
          ...
          <div className="fourOFour__words__wordsWithC__randomWordEnding">{randomWord.slice(1)}</div>
        </div>
        </div>
      </div>
    </div>
